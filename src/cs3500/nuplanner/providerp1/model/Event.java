 ...
 * java class and the list of IUsers are represented as a list of IUsers.
 */
...
public class Event {
  ...
  private final IUser hostIUser;
  private final List<IUser> invitedIUsers;
   ...
   * @param hostIUser the IUser hosting the event
   * @param invitedIUsers the list of the invited IUsers
   */
  public Event(String name, Day startDay, LocalTime startTime, Day endDay, LocalTime endTime,
               boolean online, String place, IUser hostIUser, List<IUser> invitedIUsers) {
    if (name == null || place == null || startDay == null || endDay == null || startTime == null
            || endTime == null || hostIUser == null || invitedIUsers == null) {
    ...
    this.hostIUser = hostIUser;
    this.invitedIUsers = new ArrayList<>(invitedIUsers);
  }
  ...
  /**
   * This returns the host IUser of the Event.
   */
  public IUser getHostIUser() {
    return hostIUser;
  }

  /**
   * This returns the invited IUsers of the Event.
   */
  public List<IUser> getInvitedIUsers() {
    return invitedIUsers;
  }

  /**
   * The list of the IUsers invited to the event.
   * @return the string of the IUsers invited to the event
   */
  public String invites() {
    StringBuilder result = new StringBuilder();
    for (IUser invite: this.getInvitedIUsers()) {
